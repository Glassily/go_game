...
- **棋盘绘制** - 支持2-25路围棋棋盘显示
- **棋盘交互** - 支持鼠标点击落子、右键菜单操作
- **SGF解析** - 完整支持SGF FF4格式，支持中文编码自动检测
- **SGF导出** - 将棋谱导出为标准SGF格式
- **SGF验证** - 验证棋谱格式合法性（支持严格模式）
- **图形界面** - 基于egui的现代化界面，支持明暗主题切换
- **棋谱浏览** - 支持前进、后退、首步、末步导航
- **鼠标滚轮** - 在棋盘区域使用滚轮沿主线前进/后退
- **编辑功能** - 支持编辑模式自由落子、删除着法
- **评论编辑** - 可在每一步添加和编辑文字评论
- **游戏树面板** - 可视化显示分支变着，支持节点增删
- **右键菜单** - 支持落子、右键删除、查看着法信息
- **信息编辑** - 可编辑棋局基本信息（黑方、白方、日期、贴目、结果等）
- **文件操作** - 支持新建、打开、保存、另存为SGF文件
