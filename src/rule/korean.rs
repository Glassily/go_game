...
/// 注意：实际韩国规则中，死子最后要填入对方空中，此处简化计算。
pub struct KoreanRule {
    pub komi: f64,
}

impl Default for KoreanRule {
    fn default() -> Self {
        Self { komi: 6.5 }
    }
}

impl LegalityRule for KoreanRule {}

impl ScoringRule for KoreanRule {
    fn score(
        &self,
        board: &Board,
